...
<head>
    ...
    <link href="{{ asset('administrador/assets/css/bootstrap.css') }}" rel="stylesheet" />
     <!-- FONTAWESOME STYLES-->
    <link href="{{ asset('administrador/assets/css/font-awesome.css') }}" rel="stylesheet" />
     <!-- MORRIS CHART STYLES-->
    <link href="{{ asset('administrador/assets/js/morris/morris-0.4.3.min.css') }}" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
    <link href="{{ asset('administrador/assets/css/custom.css') }}" rel="stylesheet" />
     <!-- GOOGLE FONTS-->
...
float: right;
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="login.html" class="btn btn-danger square-btn-adjust">Cerrar Sesion</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2> Administrador Hotel Atlantis</h2>   
                        <h5>Bienvenida Aida Blanco. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
...
<span class="label label-danger">Danger</span>
    ...
    <!-- JQUERY SCRIPTS -->
    <script src="{{ asset('administrador/assets/js/jquery-1.10.2.js') }}"></script>
      <!-- BOOTSTRAP SCRIPTS -->
    <script src="{{ asset('administrador/assets/js/bootstrap.min.js') }}"></script>
    <!-- METISMENU SCRIPTS -->
    <script src="{{ asset('administrador/assets/js/jquery.metisMenu.js') }}"></script>
     <!-- MORRIS CHART SCRIPTS -->
     <script src="{{ asset('administrador/assets/js/morris/raphael-2.1.0.min.js') }}"></script>
    <script src="{{ asset('administrador/assets/js/morris/morris.js') }}"></script>
      <!-- CUSTOM SCRIPTS -->
    <script src="{{ asset('administrador/assets/js/custom.js') }}"></script>
